...
from string_with_arrows import string_with_arrows # Method in file string_with_arrows.py
import string # imports all string characters
import os # imports all os settings
import math # imports math command
...
LETTERS = string.ascii_letters # All possible string characters
LETTERS_DIGITS = LETTERS + DIGITS # All possibe characters
...
class Error:
    '''
    Constructor for the error class. Takes in the start and end position of the errored character, 
    the error name, and the details (Traceback e.t.c...)
    '''
    ...
    '''
    Is a representation method. Displays the error in a "pleasant" format.
    In otherwords, it doesn't just throw a bunch of confusing things at the user.
    '''
    def as_string(self):
...
'''
The following three classes of errors are all syntax errors.
     * If there is a character that doesn't mean anything or has no functionality, an IllegalCharError will occur
     * If a user forgets to add a required character, it throws the Illegal Char Error. (Ex. Forgetting the "->" when making a function)
     * If the user incorrectly uses the functionality of the code (doesn't set up a function correctly or define a variable incorrectly)
...
# Run Time Error. Throws an error if an error occurs while executing the code (Ex. Division by 0)
class RTError(Error):
    # Same Parameters except now takes in the context for traceback
    def __init__(self, pos_start, pos_end, details, context):
        super().__init__(pos_start, pos_end, 'Runtime Error', details)
        self.context = context
    # Overrides the as_string method due to added traceback
    def as_string(self):
    ...
    def generate_traceback(self):
        ...
        '''
        While there is still context, it will take in the position (file/method/variable name) and show it in the return string.
        It then updates the context with new context for the next entery point.
        '''
        while ctx:
